...
@app.route('/2k/tab_anova/<fatores>/<replicadas>/<maty>/<matbetaAceito>',methods=['GET'])
def tabAnova2k(fatores,replicadas, maty,matbetaAceito):
    alfa = 0.05
    mult = 2
    fatores = int(fatores)
    replicadas = int(replicadas)
...
@app.route('/2k/matriTesteT/<fatores>/<replicadas>/<maty>',methods=['GET'])
def testT2k(fatores,replicadas, maty):
    alfa = 0.05
    mult = 2
    fatores = int(fatores)
    replicadas = int(replicadas)
